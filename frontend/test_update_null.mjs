...
async function main() {
  const { data, error } = await supabase.from("projects").update({ start_date: null, end_date: null }).in("id", ["50000000-0000-4000-a000-000000000001", "50000000-0000-4000-a000-000000000002"]);
