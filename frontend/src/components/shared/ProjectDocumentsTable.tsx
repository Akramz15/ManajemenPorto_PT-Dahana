      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between p-6 border-b border-slate-100 gap-4 bg-white">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Kelola seluruh dokumen terkait proyek ini.
          </p>
        </div>
        ...
        <table className="w-full text-left text-sm whitespace-nowrap">
          <thead className="bg-slate-50/50 border-b border-slate-100">
            <tr>
              ...
              <th className="px-6 py-3.5 font-bold text-slate-500 uppercase tracking-wider text-[10px] text-center w-24">
                Aksi
              </th>
            </tr>
          </thead>
                ...
                <td colSpan={4} className="py-16 text-center">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-xs font-medium text-slate-400 mt-1 max-w-xs">
                      Silakan unggah dokumen PDF atau teks terkait proyek Anda
                      di sini.
                    </p>
                  </div>
                </td>
                  ...
                  >
                    <td className="px-6 py-3.5">
                      <div className="flex items-center gap-3">
                        ...
                        <span
                          className="font-semibold text-slate-700 max-w-50 md:max-w-75 lg:max-w-100 truncate"
                          title={doc.file_name}
                        >
                          {doc.file_name}
                        </span>
