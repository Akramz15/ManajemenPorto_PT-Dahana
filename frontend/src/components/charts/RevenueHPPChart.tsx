...
function RevenueTooltip({
  ...
  const rasio =
    penjualan && hpp && penjualan.value > 0
      ...
      <div className="space-y-2">
        <div className="flex justify-between items-center gap-6">
          ...
          <span className="font-bold text-white">
            {formatRupiah(penjualan?.value ?? 0)}
          </span>
        </div>
