...
export default function NotFoundPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center gap-4 text-center p-4">
      ...
      <h1 className="text-xl font-bold text-slate-800">Halaman tidak ditemukan</h1>
      <p className="text-sm text-slate-500">Halaman yang Anda cari tidak ada atau sudah dipindahkan.</p>
