    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 min-h-125">
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100">
        ...
        <p className="text-sm text-slate-500 mt-1">
          Peta sebaran portofolio investasi beserta tingkat pengembalian (ROI)
          dan risiko
        </p>
      </div>
      ...
      <div className="card w-full min-h-125 flex flex-col items-center justify-center text-center p-8">
        ...
        <p className="text-slate-500 max-w-md mx-auto">
          Fitur analisis portofolio investasi dan afiliasi sedang dalam tahap
          pengembangan. Silakan nantikan pembaruan berikutnya dari tim kami.
        </p>
      </div>
    </div>
  );
