      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 card p-6! border-0! bg-white/80! shadow-sm!">
        <div>
          <h2 className="text-2xl font-black text-slate-900 tracking-tight">
            PT Dahana Investama Corp (DIC)
          </h2>
          <p className="text-sm font-medium text-slate-500 mt-2">
            Dashboard kinerja finansial dan operasional anak perusahaan
          </p>
        </div>

        <div className="w-full md:w-auto flex items-center justify-end gap-3 shrink-0">
          <PortfolioDriveLinks context="dic" />
      ...
      <div className="flex flex-col gap-6">
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 flex flex-col gap-6">
          <RKAPChart
            ...
            title={
              selectedRkap === "ytd"
                ? "YTD Pendapatan DIC 2026 RKAP vs Realisasi"
                : "Pendapatan DIC 2026 RKAP vs Realisasi (Per Bulan)"
            }
            headerAction={
              <select
                value={selectedRkap}
          ...
          <RKAPChart
            ...
            title={
              selectedRkap === "ytd"
                ? "YTD Laba Rugi DIC 2026 RKAP vs Realisasi"
                : "Laba Rugi Usaha DIC 2026 RKAP vs Realisasi (Per Bulan)"
            }
          />
        </div>
