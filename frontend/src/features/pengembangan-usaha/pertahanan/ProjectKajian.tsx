...
export default function ProjectKajian() {
  ...
  useEffect(() => {
    // Fetch all kajian projects for pertahanan
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-black text-slate-900 tracking-tight flex items-center gap-3">
              {selectedProject ? projectData?.nama_proyek : "Workspace: Project Kajian"}
            </h1>
            {selectedProject ? (
              <div className="flex items-center gap-3 mt-2 text-sm text-slate-600 font-medium">
                <div className="flex items-center gap-1.5">
                  <MapPin size={16} className="text-primary-600" />
                  <span>Area Pertahanan (Kajian)</span>
                </div>
        ...
        <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6 relative overflow-hidden">
               <div className="absolute -right-10 -top-10 w-40 h-40 bg-indigo-50/50 rounded-full blur-2xl"></div>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-200/60 min-h-[70vh] flex flex-col overflow-hidden">
          ...
          <div className="border-b border-slate-100 p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50/50">
            <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2">
              <ShieldAlert className="text-primary-500" /> Semua Proyek Kajian
          ...
          <div className="p-6 flex-1 bg-slate-50/30">
            {allProjects.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-slate-400 py-20">
                ...
                <p className="text-sm font-medium text-center max-w-sm">Belum ada proyek kajian di divisi pertahanan. Semua anggota tim dapat menambahkan proyek baru ke dalam workspace ini.</p>
