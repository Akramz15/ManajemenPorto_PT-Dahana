...
export default function ProjectKajian() {
  ...
  return (
    <div className={`flex flex-col overflow-x-hidden ${selectedProject ? '' : 'h-full overflow-hidden'}`}>
        ...
        <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-6">
              <KajianTimelineChecklist projectId={selectedProject} type="update" divisi="pertahanan" />
              <KajianTimelineChecklist projectId={selectedProject} type="rencana_kedepan" divisi="pertahanan" />
            </div>
            ...
            {allProjects.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-slate-400 py-20">
                ...
                <p className="text-sm font-medium text-center max-w-sm">
                  Belum ada proyek kajian di divisi pertahanan. Semua anggota
