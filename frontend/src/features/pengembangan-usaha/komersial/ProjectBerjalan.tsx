          ...
          <div className="p-6 flex-1 bg-slate-50/30">
            {allProjects.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-slate-400 py-20">
                ...
                <p className="text-sm font-medium text-center max-w-sm">Belum ada proyek berjalan di divisi komersial. Semua anggota tim dapat menambahkan proyek baru ke dalam workspace ini.</p>
